$(document).ready(function () {
    ...
    function sendOtp() {
        ...
        $.ajax({
            type: "POST",
            url: '/send-otp/signIn', // Use the URL
            data: $("#signInForm").serialize(), // Serialize the form data
            ...
            success: function (responseSuccess) {
                ...
                if (responseSuccess.response.status == true) {
                    $("#email").attr("readonly", true).removeClass("is-invalid").css('cursor', 'default');
            ...
            error: function (xhr, status, error) {
                ...
                if (xhr.responseJSON.response.status == false) {
                    if (xhr.responseJSON.response.message == "This email address is not currently registered, kindly sign up now.") {
