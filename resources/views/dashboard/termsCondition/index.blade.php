...
<div class="content-wrapper" style="background: rgb(252, 252, 252)">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h3 class="term-title">Terms & Conditions</h3>
                </div>
    ...
    <section class="content">
        <div class="container-fluid terms-condition-content">
            <div class="row g-2 justify-content-center align-items-center">
                <div class="col-12 col-lg-6 col-xl-6 col-md-6">
                    <form id="createTermCondition">
                        @csrf
                        <div class="form-group">
                            <h4 class="input-label">Title</h4>
                            <input name="title" id="title" placeholder="Add title" class="inputBorder form-input form-control title w-100" required value="{{ $termsCondition ? $termsCondition->title : '' }}">
                            <label id="title-error" class="error input-error-label" for="title"></label>
                        </div>
                        <div class="form-group mt-5 mb-5">
                            <h4 class="input-label">Description</h4>
                            <textarea id="description" name="description" class="inputBorder form-control description w-100" rows="10" required>
                                {{ $termsCondition ? $termsCondition->description : '' }}
                            </textarea>
                            <label id="description-error" class="error input-error-label" for="description"></label>
                        </div>
                        <div class="row no-gutters mt-4">
                            <div class="col-6 pr-1">
                                <a class="btn btn-outline-secondary view-button" href="{{ route('term-condition.view') }}" >View</a>
                            </div>
