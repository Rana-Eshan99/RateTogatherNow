...
<head>
    ...
    <title>Rate Together Now  | Forgot-Password</title>
...
<body style="font-family: Source Sans 3;">
            ...
            <div class="col-md-6 form-section d-flex flex-column align-items-center justify-content-center"
                ...
                <div class="text-left w-100">
                    <div class="row w-100">
                        <div class="col-12 col-sm-10 col-md-8 mx-auto">
                            ...
                            <div class="form-group mb-4" style="margin-top: 32px;">
                                ...
                                <p class="discription">Please add you email address and we will send you a
                                    link to
                    ...
                    <div class="row w-100">
                        <div class="col-12 col-sm-10 col-md-8 mx-auto">
                            <!-- Sing In Form -->
                            <form action="{{ route('password.email') }}" method="POST" id="signinForms">
                                @csrf
                                <!-- User Email Here -->
                                <div class="form-group mb-2 mt-2">
                                    <span class="feild-title">Email</span>
                                    <input type="email" name="email" id="email"
                                        class="mt-1 form-control inputFieldHeight customBorderRadius @error('email') is-invalid @enderror"
                                        value="{{ old('email') }}" placeholder="xyz@hotmail.com" maxlength="255">
    ...
    <script src="{{ asset('js/dashboard/auth/forgotPassword.js') }}"></script>
    @if (session('status'))
        <script>
