...
@section('title', 'Organization Reviews')
...
@section('content')
            ...
            <div class="container-fluid">
                <div style="max-width: 100%;" >
                    <div style="display: flex; justify-content: flex-start; align-items: center; margin-bottom: 10px;">
                        ...
                        <h1 class="orgTitle">Organization Reviews</h1>
                    </div>
                </div>
            </div>
        </section>
    ...
    @include("dashboard.organization.modal.viewReview")
    <!-- /.content-wrapper -->
@endsection
@push('scripts')
    <script src="{{ asset('js/dashboard/organization/organizationReview.js') }}"></script>
    <script>
        var organizationId = {{ $organization->id }};
        var fetchActiveOrganizationsData = "{{ route('admin.organization.organizationRating', ['id' => ':id']) }}".replace(':id', organizationId);
        var organizationReview = "{{ route('admin.organization.organizationReviewsDetail', ['id' => ':id']) }}".replace(':id', organizationId);
    </script>
@endpush
