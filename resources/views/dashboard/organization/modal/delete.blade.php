...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content" style="max-width: 362px; margin: auto; border-radius: 8px;">
            <div class="modal-body text-center">
                ...
                <div class="form-group" style="margin-top: 16px;">
                    <p class="text-center" style="font-size: 16px; font-weight: 400; font-family: \'Source Sans 3\', sans-serif;">Are you sure that you want to delete this organization?</p>
                </div>
