        ...
        <div class="modal-content" style="max-width: 362px; margin: auto; height:200px; border-radius: 11px;">
            <div class="modal-body text-center">
                ...
                <div class="form-group" style="margin-top: 6px;">
                    <p class="text-center orgPeerDeletes" style="font-size: 16px; font-weight: 400;">Are you sure that you want to delete this organization?</p>
                </div>
                <div class="form-group accent-blue" style="margin-top: 4px;">
                    <input type="hidden" name="deleteId" id="deleteId"value="{{ $organization->id }}">
