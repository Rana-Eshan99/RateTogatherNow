            ...
            <div class="modal-body text-center">
                ...
                <div class="form-group" style="margin: 32px 0;">
                    ...
                    <p id="message" style="font-size: 14px; color: #475467; font-weight: 400; margin-top: 4px;">
                        Thanks for reporting the comment, our team will<br> look into it.
                    </p>
                </div>
                ...
                <div class="form-group " style="margin-bottom: 24px;">
                    <!-- Close button -->
                    <button type="button"
                        class="btn btn-primary btn-block customBorderRadiusModel btnCus"
                        id="btnClose" style="background-color: #0678E9;font-size:16px; font-weight:600;">Close</button>
                </div>
            </div>
        </div>
    </div>
