...
<head>
    ...
    <title>Rate Together Now  | Sign-up</title>
...
<body style="font-family: poppins;">
    <div class="container-fluid container-custom">
        <div class="row w-100">
            <div class="col-12  col-md-6 col-lg-6  firstDiv d-flex justify-content-center"
                style="background-color: #000000; height:100vh  width:100%">
            ...
            <div class="col-12  col-md-6 col-lg-6  form-section d-flex flex-column align-items-center justify-content-center"
                ...
                <div class="text-left w-100">
                        ...
                        <div class="col-12 col-sm-10 col-md-8 mx-auto custmMargin">
                            ...
                            <div class="form-group mb-4" style="margin-top: 32px;">
                                <label class="mainHeading">
                                    Evaluate.<br>Improve. Empower.
                                </label>
                                </br>
                                <label class="mainHeadingPara">
                                    Sign up to create your Rate Together Now  account.
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row w-100">
                        <div class="col-12 col-sm-10 col-md-8 mx-auto">
                            <!-- Sing Up Form -->
                            <form action="{{ route('user.auth.verifyOtp', ['otpType' => 'signUp']) }}" method="POST"
                                id="signUpForm">
                                @csrf
                                <!-- User Email Here -->
                                ...
                                <div class="form-group mb-2" id="verificationDiv"
                                    ...
                                    <input type="text" name="verificationCode" id="verificationCode"
                                        ...
                                        class="form-control inputFieldHeight @error('verificationCode') is-invalid @enderror customBorderRadius"
                                ...
                                <div class="form-group manageDiv">
                                    <label class="labelForm">Already have an account? <a
                                            href="{{ route('user.auth.signInForm') }}" class="manageSignUp">Sign
                                            In</a></label>
                                </div>
                            </form>
                            <!-- / Sign Up Form Closes Here  -->
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript" src="{{ asset('js/user/auth/signUp.js') }}"></script>
