            ...
            <div class="modal-body text-center customBorderRadius">
                ...
                <div class="form-group" style="margin-bottom: 32px">
                    ...
                    <span style="font-size: 18px; color:#101828; font-weight:600;">
                        Thank You for Adding a New <br>Organization
                    </span>
                    <!-- Message -->
                    <span id="message" style="font-size: 14px; color: #475467; font-weight:400">
                        <p style="margin-top: 4px;">Our team will review the details you submitted.<br>
                            Once approved, the organization will be available<br> for our users.</p>
                    </span>
