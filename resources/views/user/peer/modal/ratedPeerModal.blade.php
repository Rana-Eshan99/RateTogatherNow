        ...
        <div class="modal-content customBorderRadius" style="width: 472px">
            <div class="modal-body text-center customBorderRadius">
                ...
                <div class="form-group" style="margin-bottom: 32px; margin-top:32px;">
                    <!-- heading -->
                    <lablel style="font-size: 18px; color:#101828; font-weight:600;">
                        Feedback Submitted
                    </lablel>
                    <br>
                    <!-- Message -->
                    <lablel id="message" style="font-size: 14px; font-weight:400; color:#475467; margin-top:4px;">
                        We value your feedback. It will be available to all<br> users after our team has reviewed your rating.
                    </lablel>
                </div>
